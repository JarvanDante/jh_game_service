...
// IgPgGame is the golang structure of table ig_pg_game for DAO operations like Where/Data.
type IgPgGame struct {
	g.Meta           `orm:"table:ig_pg_game, do:true"`
	Id               any         // 主键ID
	SiteCode         any         // 站点编码
